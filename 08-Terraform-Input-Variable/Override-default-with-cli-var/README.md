...
- We are going to override the default values defined in  by providing new values using the `-var` argument using CLI
```t
...
terraform plan -var="resource_group_name=demorg" -var="resource_group_location=westus"

terraform apply -var="resource_group_name=demorg" -var="resource_group_location=westus"
```
